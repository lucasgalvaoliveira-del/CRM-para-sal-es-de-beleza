...
--
-- Baseline: captura tudo que já estava aplicado no projeto real
-- (jumyrtjjgnzhcbhvckgo) antes da adoção do Supabase CLI para
-- versionar migrations. A partir daqui, toda mudança de schema é
-- um arquivo novo em supabase/migrations/, nunca edição retroativa
-- deste. Ver docs/database/DATABASE.md#estratégia-de-migrations.
-- ============================================================
